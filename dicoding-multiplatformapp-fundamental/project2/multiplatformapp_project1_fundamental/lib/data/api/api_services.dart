...
class ApiServices {
  ...
  Future<BaseDetailRestaurantResponse> getDetailRestaurant(
  ...
  Future<BaseCustomerReviewResponse> addReview(
  ...
  Future<BaseSearchRestaurantResponse> searchRestaurant(String search) async {
    final response = await client.get(Uri.parse("$_baseUrl/search?q=$search"));
